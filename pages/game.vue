  ...
  data () {
    return {
      ...
      gameDatas: [
        ...
        {
          date: moment('2021-11-14'),
          place: '美原体育館',
          opponent: 'Three Horses',
          opponentPoint: 101,
          originalPoint: 72
        },
        {
          date: moment('2021-11-07'),
          place: '臨海スポーツセンター',
          opponent: '履正社医療スポーツ専門学校',
          opponentPoint: 65,
          originalPoint: 85
        }
      ]
